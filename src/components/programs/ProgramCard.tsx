...
export function ProgramCard({ program }: { program: Program }) {
  return (
    <article className="flex h-full flex-col rounded-2xl bg-white p-6 shadow-[0_10px_30px_rgba(26,39,68,0.06)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(26,39,68,0.1)]">
